...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', metavar='Topology file', type=str,
                        default="../Novel-scale-sim-v2-main_Tanmay_Mudit/topologies/conv_nets/alexnet_part.csv",
                        
                        help="Path to the topology file"
                        )
    parser.add_argument('-c', metavar='Config file', type=str,
                        default="../Novel-scale-sim-v2-main_Tanmay_Mudit/configs/scale.cfg",
                        help="Path to the config file"
                        )
    parser.add_argument('-p', metavar='log dir', type=str,
                        default="../Novel-scale-sim-v2-main_Tanmay_Mudit/test_runs",
