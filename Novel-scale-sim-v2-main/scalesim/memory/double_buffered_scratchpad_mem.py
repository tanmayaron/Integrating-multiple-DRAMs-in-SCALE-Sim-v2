...
class double_buffered_scratchpad:
    ...
    def service_memory_requests(self, ifmap_demand_mat, filter_demand_mat, ofmap_demand_mat):
        ...
        for i in tqdm(range(ofmap_lines), disable=pbar_disable):
            ...
            #Not counting ofmap_stalls for stall_cycles because cycle_arr is initialized in different loop. It will compare the last value of 
            # first loop with ofmap_serviced_cycles of current loop
            self.stall_cycles += int(max(ifmap_stalls[0], filter_stalls[0]))
            #self.stall_cycles += int(ifmap_stalls[0])
    ...
    def get_ofmap_dram_details(self):
        ...
        #self.ofmap_dram_writes += self.ofmap_buf.get_num_accesses(2)
    ...
    def get_ifmap_dram_trace_matrix_1(self):
        return self.ifmap_buf.get_trace_matrix_1()
    
    def get_filter_dram_trace_matrix_2(self):
        return self.filter_buf.get_trace_matrix_2()

    def get_ofmap_dram_trace_matrix_1(self):
        return self.ofmap_buf.get_trace_matrix_1()
    
    def get_ifmap_dram_trace_matrix_2(self):
        return self.ifmap_buf.get_trace_matrix_2()

    def get_filter_dram_trace_matrix_1(self):
        return self.filter_buf.get_trace_matrix_1()

    def get_ofmap_dram_trace_matrix_2(self):
        return self.ofmap_buf.get_trace_matrix_2()
    
    def get_dram_trace_matrices(self):
        dram_ifmap_trace_1 = self.ifmap_buf.get_trace_matrix_1()
        dram_filter_trace_1 = self.filter_buf.get_trace_matrix_1()
        dram_ofmap_trace_1 = self.ofmap_buf.get_trace_matrix_1()

        dram_ifmap_trace_2 = self.ifmap_buf.get_trace_matrix_2()
        dram_filter_trace_2 = self.filter_buf.get_trace_matrix_2()
        dram_ofmap_trace_2 = self.ofmap_buf.get_trace_matrix_2()

        return dram_ifmap_trace_1, dram_filter_trace_1, dram_ofmap_trace_1, dram_ifmap_trace_2, dram_filter_trace_2, dram_ofmap_trace_2
    ...
    def print_ifmap_dram_trace_1(self, filename):
        self.ifmap_buf.print_trace_1(filename)

    #
    def print_filter_dram_trace_1(self, filename):
        self.filter_buf.print_trace_1(filename)

    #
    def print_ofmap_dram_trace_1(self, filename):
        self.ofmap_buf.print_trace1(filename)

    def print_ifmap_dram_trace_2(self, filename):
        self.ifmap_buf.print_trace_2(filename)

    #
    def print_filter_dram_trace_2(self, filename):
        self.filter_buf.print_trace_2(filename)

    #
    def print_ofmap_dram_trace_2(self, filename):
        self.ofmap_buf.print_trace2(filename)
