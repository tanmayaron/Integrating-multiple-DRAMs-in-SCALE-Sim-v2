...
class single_layer_sim:
    ...
    def save_traces(self, top_path):
        ...
        ifmap_sram_filename1 = dir_name +  '/IFMAP_SRAM_TRACE.csv'
        filter_sram_filename1 = dir_name + '/FILTER_SRAM_TRACE.csv'
        ofmap_sram_filename1 = dir_name +  '/OFMAP_SRAM_TRACE.csv'

        ifmap_dram_filename1 = dir_name +  '/IFMAP_DRAM_TRACE1.csv'
        filter_dram_filename1 = dir_name + '/FILTER_DRAM_TRACE1.csv'
        ofmap_dram_filename1 = dir_name +  '/OFMAP_DRAM_TRACE1.csv'

        ifmap_dram_filename2 = dir_name +  '/IFMAP_DRAM_TRACE2.csv'
        filter_dram_filename2 = dir_name + '/FILTER_DRAM_TRACE2.csv'
        ofmap_dram_filename2 = dir_name +  '/OFMAP_DRAM_TRACE2.csv'

        self.memory_system.print_ifmap_sram_trace(ifmap_sram_filename1)
        self.memory_system.print_ifmap_dram_trace_1(ifmap_dram_filename1)
        self.memory_system.print_filter_sram_trace(filter_sram_filename1)
        self.memory_system.print_filter_dram_trace_1(filter_dram_filename1)
        self.memory_system.print_ofmap_sram_trace(ofmap_sram_filename1)
        self.memory_system.print_ofmap_dram_trace_1(ofmap_dram_filename1)

        self.memory_system.print_ifmap_dram_trace_2(ifmap_dram_filename2)
        self.memory_system.print_filter_dram_trace_2(filter_dram_filename2)
        self.memory_system.print_ofmap_dram_trace_2(ofmap_dram_filename2)
